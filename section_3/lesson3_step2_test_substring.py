...
# https://stepik.org/lesson/36285/step/9
...
# значениях, проверьте вывод вашей функции на разных парах. Обрабатывать ситуацию с пустым или невалидным вводом
# не нужно.
...
Коректные варианты других студентов:
